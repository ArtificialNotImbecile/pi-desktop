...
| [x] | CHAT-001 | Composer and active chat | Rich editing, commands, attachments, streaming, queueing, stopping, editing, and regeneration work. | `tests/e2e/composer.spec.ts`, `tests/e2e/chat-runtime.spec.ts` |
